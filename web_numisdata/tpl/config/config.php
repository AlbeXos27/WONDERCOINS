...
// db . force use this db instead of default (useful for multiple publications)
	define('WEB_DB'	 ,'web_numisdata_default');
...
// site config
	...
	// __web_base_url__ . absolute url base to target web. Used to build absolute calls to elements
		define('__WEB_BASE_URL__', 'https://wwwondercoins.uca.es');
	...
	// EMAIL
		define('EMAIL', 'elena.moreno@uca.es');
	...
	// DEDALO_CONTROL_ACCESS
		define('DEDALO_CONTROL_ACCESS', false);
...
// api config
	...
	// api_web_user_code
		...
		define('API_WEB_USER_CODE', '12sdf58d91fgt_66sdfc-_ssddsDF_F*l'); // 5eDfj2ñlowqQqXjkas6sad87asWa
