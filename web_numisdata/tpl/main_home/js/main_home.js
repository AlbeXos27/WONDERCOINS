	...
	*/
	set_up : function(options) {
		...
		// form
			...
			let menuItem = document.querySelector("#menu li[role='numisdata349_58']");
			let links = menuItem.querySelectorAll(".links.links_inside li a");

			// Muestra el contenido de texto del enlace
			links.forEach((link, index) => {
				let x=link.href.replace("https://wwwondercoins.uca.es/web_numisdata/","");
				console.log(x);
				link.href=x
			});
